...
export default function VKCallbackPage() {
  return (
    <Suspense fallback={
      <Box minH="100vh" bg="linear-gradient(135deg, #4c84ff 0%, #2563eb 100%)" display="flex" alignItems="center" justifyContent="center">
        <VStack gap={4}>
          <Spinner size="xl" color="white" />
          <Text color="white" fontSize="lg">Обработка авторизации VK...</Text>
        </VStack>
      </Box>
    }>
      <VKCallbackContent />
